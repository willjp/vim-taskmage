...
class Test_TaskData(object):
    ...
    def test_finalize_sets_modified_when_null(self):
        print('todo')
        assert False

    def test_finalize_does_not_change_non_null_modified(self):
        print('todo')
        assert False

    def test_finalize_does_not_change_created_if_non_null(self):
        print('todo')
        assert False
